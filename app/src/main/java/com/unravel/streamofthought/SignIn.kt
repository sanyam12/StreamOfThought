...
class SignIn: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent.getStringExtra("bool").toString()=="true")
        {
            Snackbar.make(findViewById(R.id.button3), "You were logged out", 1000)
...
//                                        .setAction("action", null).show()
                                    ...
                                    Snackbar.make(
                                        findViewById(R.id.signinEditMail),
        ...
        val signup: TextView = findViewById(R.id.textView8)
